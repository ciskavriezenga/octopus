...
#ifndef OCTOPUS_CORE_EQUAL_HPP
#define OCTOPUS_CORE_EQUAL_HPP
...
namespace octo
{
	...
	template <typename T>
	class Equal : public CachedSignal<T>
	{
	public:
		using CachedSignal<T>::CachedSignal;
        
    public:
        //! The left-side value of the equal operator
        Value<float> left = 0;
        
        //! The right-side value of the equal operator
        Value<float> right = 0;
